        ...
        <ul class="home-nav__list row list-unstyled">
          <li class="home-nav__cafe col-xs-12 col-sm-4">
            <div class="home-nav__thumbnail">
              <a href="<?php echo esc_url(home_url( '/menu#menu-cafe' ) ); ?>"><img src="./img/nav-cafe.jpg" alt="" class="img-responsive img-thumbnail"/></a>
            </div>
          ...
          <li class="home-nav__lunch col-xs-12 col-sm-4">
            <div class="home-nav__thumbnail">
              <a href="<?php echo esc_url(home_url( '/menu#menu-lunch' ) ); ?>"><img src="./img/nav-lunch.jpg" alt="" class="img-responsive img-thumbnail"/></a>
            </div>
            <div class="home-nav__text">
          ...
          <li class="home-nav__dinner col-xs-12 col-sm-4">
            <div class="home-nav__thumbnail">
              <a href="<?php echo esc_url(home_url( '/menu#menu-dinner' ) ); ?>"><img src="./img/nav-dinner.jpg" alt="" class="img-responsive img-thumbnail"/></a>
            </div>
            <div class="home-nav__text">
